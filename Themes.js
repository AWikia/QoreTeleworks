...
/* Visual Themes */
var visualThemes = ['contrast','contrast'];
var visualColors = ['standard','forcedcolors'];
var visualThemeNames = ['High Contrast','High Contrast (Forced Colors)'];
var contrastVisual = 0;
